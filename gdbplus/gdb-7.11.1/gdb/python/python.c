...
message == an error message without a stack will be printed."),
  ...
  if (gdbpy_initialize_auto_load () < 0
      ...
      || gdbpy_initialize_heap_block () < 0
      || gdbpy_initialize_object_ref () < 0)
    goto fail;
...
Return a tuple containing all inferiors." },
  {"heap_block", gdbpy_heap_block, METH_VARARGS,
    "Return the heap memory block with given address." },
  {"heap_walk", gdbpy_heap_walk, METH_VARARGS,
    "Return the next heap memory block." },
  {"big_block", gdbpy_big_blocks, METH_VARARGS,
    "Return biggest heap memory blocks in size." },
  {"cpp_object", gdbpy_cpp_object, METH_VARARGS,
    "Return C++ objects of the type same as the input expression." },
  {"shared_object", gdbpy_shared_object, METH_VARARGS,
    "Return objects accessed by multiple threads." },
  {"ref", gdbpy_ref, METH_VARARGS,
